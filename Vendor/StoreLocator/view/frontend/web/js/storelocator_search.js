    ...
    function($,country_list) {        
        ...
        return {
            ...
            search : function(map,config) {                        
                ...
                $(".storelocator-results").append("<span class='results-word'>Results for <span class='italic'>" + this.address() + ":</span></span><br />");
                                ...
                                if (results[0]["types"][0] == "country") {
                                    ...
                                    for (i = 0; i < markers.length; i++) { 
                                        if (markers[i].global_country == code_country) {
                                            ...
                                            contentToAppend += "</div>";
                                            $(".storelocator-results").append(contentToAppend);
                                        }
                                    }
                                }
                                else{
                                    ...
                                    var circle = new google.maps.Circle({
                                        map: map,
                                        radius: config.radius,    // value from admin storelocator
                                    ...
                                    var $wrapper = $('.storelocator-results');
